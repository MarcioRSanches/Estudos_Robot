...
Teste de Argumentos Opcionais
    Passando argumentos opcionais como parâmetro      nome=Marcio   ultimo_nome=Sanches
    Passando argumentos opcionais como parâmetro      nome=Marcio   nome_do_meio=Rodrigues     ultimo_nome=Sanches
...
Criando lista e dicionário via parâmetro
    ...
    Teste Criando uma Lista         Marcio   Rodrigues   Sanches
    Teste Criando os dois           Marcio   Rodrigues   Sanches    shell=True    env=False
...
Passando argumentos opcionais como parâmetro
    ...
    [Arguments]     ${nome}   ${ultimo_nome}   ${nome_do_meio}=Teles
